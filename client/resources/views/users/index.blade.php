    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="flex flex-col md:flex-row justify-between items-center mb-8">
            <div class="mb-4 md:mb-0">
                <h1 class="text-3xl font-bold text-indigo-800">Manajemen Data Users</h1>
                <p class="text-gray-600">Sistem pengelolaan data pengguna</p>
            </div>
            ...
            @if (count($users) == 0)
                <div class="p-8 text-center">
                    ...
                    <p class="mt-1 text-gray-500">
                        ...
                        @else
                            Silakan tambahkan data user dengan menekan tombol "Tambah User" di atas.
                        @endif
                    </p>
                </div>
            @else
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-indigo-50">
                            <tr>
                                ...
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-indigo-800 uppercase tracking-wider">No. Tlp</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach ($users as $i => $user)
                                <tr class="hover:bg-gray-50 transition-colors">
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $user['Role']['nama_role'] }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $user['nama'] }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $user['email'] }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $user['no_tlp'] }}</td>
